...
/* harmony default export */ var build_input = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    return () => {
      ...
      // 输入框
      let inputItem = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)(getInputItem(inputType), inputAttrs, inputSlots);
      // 输入框前后插槽
      let {
        beforeInput,
        afterInput
      ...
      if (inputType == 'password') {
        ...
        if (inputAttrs.text) {
          inputItem = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('label', null, [inputItem, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('span', null, ' ' + inputAttrs.text)]);
        }
      }
...
/* harmony default export */ var build_form = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    function formSlots() {
      ...
      return {
        ...slots,
        default: () => [slots.formPrepend ? slots.prepend() : null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)(build_field, {
          ...attrs,
          fields: props.fields,
...
/* harmony default export */ var a_btn = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  name: "a-btn",
  props: {
    label: String,
    icon: Object,
  ...
  setup(props, {
    ...
    return () => {
      ...
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)(web_vue_root_ArcoDesignVue_.Button, attrs, slots);
    };
  }
}));
function buildIcon(icon) {
  ...
  if (icon.__v_isVNode) {
    ...
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)(icon, {
      size: '1.1em'
    });
  }
}
